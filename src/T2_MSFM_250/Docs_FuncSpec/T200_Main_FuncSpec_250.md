# [MSFM-T240_v250] T200_Main 기능 규격서

본 문서는 **MSFM-T240_v250** 임베디드 펌웨어의 최상위 통합 진입점 모듈인 `T200_Main`에 대한 기능 규격서입니다. 시스템 부트스트랩, 물리 제어 신호 인터럽트 처리 및 FSM 유지 관리 루프 호출의 설계 스펙을 상세히 다룹니다.
