...
namespace T2_Def {
    ...
    namespace Audio {
        ...
        namespace FeatureLimit {
            ...
            // v243: 진동 3축 + 오디오 1축 통합 텐서 지원을 위해 4배 확장 (96 * 4 = 384)
            inline constexpr uint32_t    MFCC_DIM_MAX            = MFCC_COEFFS_MAX * MFCC_COMPONENTS_MAX * 4; 
            inline constexpr uint32_t    MFCC_DIM_DEF            = MFCC_COEFFS_DEF * MFCC_COMPONENTS_DEF * 4; 
