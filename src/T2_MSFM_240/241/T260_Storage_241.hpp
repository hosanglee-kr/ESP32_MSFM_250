...
private:
    ...
    char _activePath[T2_Config::StorageLimit::MAX_PATH_LEN_CONST];
    char _activeRawPath[T2_Config::StorageLimit::MAX_PATH_LEN_CONST];
    ...
    struct IndexItem {
        char path[T2_Config::StorageLimit::MAX_PATH_LEN_CONST];
        char raw_path[T2_Config::StorageLimit::MAX_PATH_LEN_CONST];
        uint32_t size_bytes;
        uint64_t created_epoch;
        uint32_t record_count;
    } _indexItems[T2_Config::StorageLimit::MAX_ROTATE_LIST_CONST];
