...
private:
    ...
    // 윈도우 함수 버퍼
    alignas(16) float _audWindow[T2_Config::System::AUD_FFT_SIZE_CONST];
    alignas(16) float _vibWindow[T2_Config::System::VIB_FFT_SIZE_CONST];
    ...
    alignas(16) float _firEqState[T2_Config::FeatureLimit::FIR_TAPS_CONST];


    // --- Audio 전용 상태 변수 (1채널 병합) ---
    float _prevPreEmpAudio = 0.0f;
    alignas(16) float _medianHistAudio[T2_Config::Dsp::MEDIAN_WINDOW_DEF];
    alignas(16) float _audioBufA[T2_Config::System::FFT_SIZE_AUDIO_CONST];
    alignas(16) float _audioBufB[T2_Config::System::FFT_SIZE_AUDIO_CONST];
    ...
    alignas(16) float _firHpfAudioCoeffs[T2_Config::FeatureLimit::FIR_TAPS_CONST];
    alignas(16) float _firLpfAudioCoeffs[T2_Config::FeatureLimit::FIR_TAPS_CONST];
    alignas(16) float _firStateHpfAudio[T2_Config::FeatureLimit::FIR_TAPS_CONST];
    alignas(16) float _firStateLpfAudio[T2_Config::FeatureLimit::FIR_TAPS_CONST];
    ...
    alignas(16) float _medianHistVib[T2_Config::System::VIB_AXIS_CONST][T2_Config::Dsp::MEDIAN_WINDOW_DEF];
    alignas(16) float _vibBufA[T2_Config::System::VIB_AXIS_CONST][T2_Config::System::FFT_SIZE_VIB_CONST];

    fir_f32_t         _firInstHpfVib[T2_Config::System::VIB_AXIS_CONST];
    fir_f32_t         _firInstLpfVib[T2_Config::System::VIB_AXIS_CONST];
    alignas(16) float _firHpfVibCoeffs[T2_Config::FeatureLimit::FIR_TAPS_CONST];
    alignas(16) float _firLpfVibCoeffs[T2_Config::FeatureLimit::FIR_TAPS_CONST];
    alignas(16) float _firStateHpfVib[T2_Config::System::VIB_AXIS_CONST][T2_Config::FeatureLimit::FIR_TAPS_CONST];
    alignas(16) float _firStateLpfVib[T2_Config::System::VIB_AXIS_CONST][T2_Config::FeatureLimit::FIR_TAPS_CONST];
