/* ============================================================================
 * File: T210_Def_243_4.hpp
 * Summary: T240 4-Tier 통합 상수/기본값 정의 SSOT (Type 구조체 분리본)
 * ============================================================================
 ...
 * 5. [현장 방어벽]: 파일 개수 제한, 게인 증폭 한계, 검사 반복 횟수 등 예외 상황 방어.
 * ========================================================================== */
...
namespace T2_Def {
    ...
    namespace Global {
        namespace System {
            inline constexpr char const* VERSION_STR         = "T240_v243_4";
        ...
        namespace StorageLimit {
            ...
            inline constexpr uint16_t    MAX_DIR_FILES_CONST = 100; // 탐색 지연 방어
