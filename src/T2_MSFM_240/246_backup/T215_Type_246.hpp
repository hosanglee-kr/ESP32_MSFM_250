 ...
 * 5. [매직넘버 제로]: 모든 배열 크기는 T210_Def_246.hpp의 SSOT 상수를 상속.
 * ========================================================================== */
...
// [Block 4-2] 오디오 스테레오 결합 지표 (448 Bytes 완벽 정렬)
...
// 16B 완벽 정합성 통합 슬롯: 32 + 304 + 224 + 448 + 3072 = 4080 Bytes (4080 / 16 = 255)
...
struct ST_PktTelemetry_t {
    ...
    uint8_t  gyro_mask;
    uint8_t  audio_mask;
    uint8_t  payload_type;      // 16 Bytes 선행 오프셋 확보
