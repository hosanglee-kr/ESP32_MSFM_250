...
bool CL_T2_SequenceBuilder::init(uint16_t p_sequenceFrames, uint16_t p_featureDim) {
    ...
    _frames = (p_sequenceFrames > T2_Def::System::SEQUENCE_FRAMES_MAX_CONST) ?
               T2_Def::System::SEQUENCE_FRAMES_MAX_CONST : p_sequenceFrames;

    _dim = (p_featureDim > T2_Def::System::MFCC_DIM_CONST) ?
            T2_Def::System::MFCC_DIM_CONST : p_featureDim;
