...
private:
	// 행렬 연산 상수 및 스크래치
    static constexpr uint16_t MEL_PADDED 		= (T2_Def::System::MEL_BANDS_CONST + 3) & ~3;
    static constexpr uint16_t BINS_PADDED 		= ((T2_Def::System::FFT_SIZE_AUDIO_CONST / 2 + 1) + 3) & ~3;
    static constexpr uint16_t MFCC_PADDED 		= (T2_Def::System::MFCC_COEFFS_CONST + 3) & ~3;
    ...
    alignas(16) float _fftWorkVib[T2_Def::System::VIB_AXIS_CONST][T2_Def::System::FFT_SIZE_VIB_CONST * 2];
    alignas(16) float _powerVib[T2_Def::System::VIB_AXIS_CONST][T2_Def::System::FFT_SIZE_VIB_CONST];
    alignas(16) float _windowVib[T2_Def::System::FFT_SIZE_VIB_CONST];

    // MFCC 히스토리
    uint16_t _historyCount;
    alignas(16) float _mfccHistory[5][T2_Def::System::MFCC_COEFFS_CONST];
    alignas(16) float _deltaHistory[5][T2_Def::System::MFCC_COEFFS_CONST];
