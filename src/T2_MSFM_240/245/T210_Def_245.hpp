/* ============================================================================
 * File: T210_Def_245.hpp
 * Summary: T240 4-Tier 시스템 상수 정의 및 동적 파라미터 SSOT (v245 완전체)
 * ============================================================================
 * [구현 원칙 및 아키텍처 가이드라인 - v245]
...
namespace Global {
    ...
    namespace Path {
        ...
        inline constexpr char const* FILE_CFG_JSON_CONST   = "/sys/runtime_cfg_245.json";     // 런타임 동적 설정값
    ...
    namespace Net {
        ...
        inline constexpr char const*  WS_URI_CONST             = "/api/t240/ws";    // 웹소켓 URI
...
namespace Imu {
    namespace Hardware {
        ...
        inline constexpr uint8_t  PIN_INT1_CONST           = 11;        // BMI270 INT1 수신 핀
...
namespace Accel {
    ...
    namespace Trigger {
        ...
        inline constexpr float        CREST_NG_THRESH_DE   = 6.0f;  // 파고율 결함 임계치
        inline constexpr float        SKEW_NG_THRESH_DE    = 1.5f;  // 왜도 결함 임계치
    ...
    namespace Calib {
        inline constexpr char const*  FILE_JSON_CONST     = "/sys/acc_calib_245.json";  // 가속도 영점 보정 파일
...
namespace Gyro {
    ...
    namespace Calib {
        inline constexpr char const* FILE_JSON_CONST         = "/sys/gyr_calib_245.json";
...
namespace Audio {
    ...
    namespace Calib {
        inline constexpr char const*  FILE_JSON_CONST        = "/sys/aud_calib_245.json";  // 마이크 EQ 보정 파일
