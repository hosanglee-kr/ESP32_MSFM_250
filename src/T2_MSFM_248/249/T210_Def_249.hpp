...
namespace Global {
    ...
    namespace Path {
        ...
        inline constexpr char const* FILE_CFG_JSON_CONST   = "/sys/cfg_249.json";     // 런타임 동적 설정값
        inline constexpr char const* FILE_CFG_TMP_CONST    = "/sys/cfg_249.json.tmp";           // 설정 임시 파일 경로
        inline constexpr char const* FILE_IDX_JSON_CONST   = "/sys/idx_249.json";     // 인덱스 파일 경로
        inline constexpr char const* FILE_IDX_TMP_CONST    = "/sys/idx_249.json.tmp";            // 인덱스 임시 파일 경로
...
namespace Accel {
    ...
    namespace Calib {
        inline constexpr char const*  FILE_JSON_CONST     = "/sys/acc_calib_249.json";  // 가속도 영점 보정 파일
...
namespace Gyro {
    ...
    namespace Calib {
        inline constexpr char const* FILE_JSON_CONST         = "/sys/gyr_calib_249.json";
...
namespace Audio {
    ...
    namespace Calib {
        inline constexpr char const*  FILE_JSON_CONST        = "/sys/aud_calib_249.json";  // 마이크 EQ 보정 파일
