/* ============================================================================
 * File: T280_Calibrator_248.hpp
 * Summary: 멀티모달 오프라인 캘리브레이션 및 하드웨어 프로파일링 엔진 (v245)
 * ============================================================================
 * [로직 상태 추적 (Logic State Tracker)]
 * - 유지: Welch's Method 기반 파워 스펙트럼 평균 추출 및 IFFT 역산 알고리즘.
 * - 갱신: v245 도메인 격리에 따른 개별 .acc, .gyr, .wav 파일 분리 로딩 및 파싱.
...
private:
    struct CalibTaskParam {
        ...
        char filePath[T2_Def::Global::StorageLimit::PATH_LEN_MAX];
        bool isManual;
    };
