    ...
    while (v_this->_state != T2_Type::EM_SystemState_t::INIT) {
        if (v_this->_state == T2_Type::EM_SystemState_t::MONITORING ||
            ...
            if (v_this->_sensor.getAccumulatedAccelCount() >= T2_Def::Accel::Sensor::FFT_SIZE_MAX) {
                ...
                if (v_this->_dsp.getAccBufX()) memcpy(v_this->_dsp.getAccBufX(), acc_proc_x, T2_Def::Accel::Sensor::FFT_SIZE_MAX * sizeof(float));
                if (v_this->_dsp.getAccBufY()) memcpy(v_this->_dsp.getAccBufY(), acc_proc_y, T2_Def::Accel::Sensor::FFT_SIZE_MAX * sizeof(float));
                if (v_this->_dsp.getAccBufZ()) memcpy(v_this->_dsp.getAccBufZ(), acc_proc_z, T2_Def::Accel::Sensor::FFT_SIZE_MAX * sizeof(float));
                if (v_this->_dsp.getGyrBufX()) memcpy(v_this->_dsp.getGyrBufX(), gyr_proc_x, T2_Def::Gyro::Sensor::FFT_SIZE_MAX * sizeof(float));
                if (v_this->_dsp.getGyrBufY()) memcpy(v_this->_dsp.getGyrBufY(), gyr_proc_y, T2_Def::Gyro::Sensor::FFT_SIZE_MAX * sizeof(float));
                if (v_this->_dsp.getGyrBufZ()) memcpy(v_this->_dsp.getGyrBufZ(), gyr_proc_z, T2_Def::Gyro::Sensor::FFT_SIZE_MAX * sizeof(float));
...
void CL_T2_FsmManager::_audioProcessTask(void* p_param) {
    ...
    float* p_outL = v_this->_dsp.getPrcBufL();
    float* p_outR = v_this->_dsp.getPrcBufR();
    float* p_rawL = v_this->_dsp.getCapBufL();
    float* p_rawR = v_this->_dsp.getCapBufR();
